...
public class SkyboxShader extends ShaderProgram{
    ...
    public void loadViewMatrix(Camera camera){
    	...
    	Matrix4f modelMatrix = Maths.createTransformationMatrix(new Vector3f(camPos.x, 0, camPos.z), 0, rotation, 0, 1);
        Matrix4f viewMatrix = Maths.createViewMatrix(camera);
        super.loadMatrix(location_viewMatrix, Matrix4f.mul(viewMatrix, modelMatrix, null));
    }
